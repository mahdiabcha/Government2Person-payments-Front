...
@Component({
  ...
  styles: [`
    ...
    /* Responsive: stack table at very small widths */
    ...
    <div class="hero">
      <div class="flex flex-col md:flex-row md:items-end justify-between gap-3">
        ...
        <div class="controls flex flex-col sm:flex-row gap-2">
          <input class="control" placeholder="Search by ID, program, reason…"
      ...
      <table>
        ...
        <tbody>
          <tr *ngFor="let e of items; trackBy: track" class="border-b">
            ...
            <td data-label="Program">#{{ e.programId }}</td>
...
export class EnrollmentsPage {
  ...
  exportCsv() {
    const rows = [
      ['ID','Program','Status','Reason','Created'],
      ...this.items.map(e => [
        `#${e.id}`, `#${e.programId}`, e.status,
